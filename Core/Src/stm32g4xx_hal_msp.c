...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB12     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(FET_TEMP_GPIO_Port, FET_TEMP_Pin);

    HAL_GPIO_DeInit(CS_U_GPIO_Port, CS_U_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB11     ------> ADC2_IN14
    */
    HAL_GPIO_DeInit(GPIOA, VBUS_ADC_Pin|MOTOR_TEMP_Pin);

    HAL_GPIO_DeInit(GPIOB, CS_W_Pin|CS_V_Pin);
